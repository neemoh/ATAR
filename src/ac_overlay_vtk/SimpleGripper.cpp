...
void SimpleGripper::SetPoseAndJawAngle(const KDL::Frame pose,
...
void SimpleGripper::AddToWorld(btDiscreteDynamicsWorld * bt_world) {
...
void SimpleGripper::AddToActorsVector(
...
bool SimpleGripper::IsGraspingObject(btDiscreteDynamicsWorld* bt_world,
                                     btCollisionObject *obj) {

    MyContactResultCallback result;
    bt_world->contactPairTest(gripper_links[3]->GetBody(),
                              obj, result);
    bool jaw1 = result.connected;

    bt_world->contactPairTest(gripper_links[4]->GetBody(),
                              obj, result);
    bool jaw2 = result.connected;
