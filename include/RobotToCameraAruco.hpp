...
public:
    ...
    void MakeTr(std::vector <cv::Point3d> axisPoints, cv::Matx33d &_rotm, cv::Vec3d &br_tvec);

    void GetTr();

    void CalculateTransformation(std::vector <cv::Point3d> axis_points , cv::Matx33d &_rotm, cv::Vec3d &br_tvec);
    void CalculateTransformationN(
